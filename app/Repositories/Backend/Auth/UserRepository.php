...
class UserRepository extends BaseRepository
{
     ...
     * @return mixed
     */
    public function getActivePaginated($paged = 25, $orderBy = 'created_at', $sort = 'desc',$searchbyfirstName='',$searchbylastName='',$searchbyEmail='') : LengthAwarePaginator
    {
        // return $this->model
        ...
        $users = $this->model->with('roles', 'permissions', 'providers')->active();
        if($searchbyEmail!=''){
