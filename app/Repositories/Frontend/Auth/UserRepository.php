...
class UserRepository extends BaseRepository
{
     ...
     * @throws GeneralException
     */
    public function update($id, array $input, $image = false,$avtar_image =false,$remove_profile_image=0)
    {
        ...
        $user->is_sp = $input['is_sp'];
        if($user->slug =='' && $input['is_sp']==1)
        {
            $user->slug = str_slug($input['slug'], "-");
        }
        ...
        if ($avtar_image) {
            ...
            // $user->avatar_location = 'avatars/'.$avatar;
