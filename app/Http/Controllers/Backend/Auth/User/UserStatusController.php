...
class UserStatusController extends Controller
{
    ...
    public function getDeactivated(ManageUserRequest $request)
    {
        ...
        return view('backend.auth.user.deactivated',compact('searchbyfirstName','searchbylastName','searchbyEmail'))
            ->withUsers($this->userRepository->getInactivePaginated(25, 'id', 'asc',$searchbyfirstName,$searchbylastName,$searchbyEmail));
    }
    ...
    public function delete(ManageUserRequest $request, User $deletedUser)
    {
        ...
        return redirect()->route('admin.auth.user.index')->withFlashSuccess(__('alerts.backend.users.deleted_permanently')); /// change by bindiya
    }
