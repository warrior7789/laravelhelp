...
class UpdatePasswordController extends Controller
{
    ...
    public function update(UpdatePasswordRequest $request)
    {
        ...
        $url = \Illuminate\Support\Facades\URL::route('frontend.user.account').'#password';
        return \Redirect::to($url)->withFlashSuccess(__('strings.frontend.user.password_updated'));
    }
}
