    ...
    {{ html()->form('POST', route('admin.auth.user.store'))->class('form-horizontal')->open() }}
        <div class="card">
                                                    ...
                                                    @foreach($roles as $role)
                                                        <div class="card">
                                                            <div class="card-header">
                                                                ...
                                                                <div class="checkbox d-flex align-items-center">
                                                                    {{ html()->label(
                                                                            html()->radio('roles[]', false, $role->name)
                                                                                  ->class('switch-input roledata')
                                                                                  ->id('role-'.$role->id)
                                                                                . '<span class="switch-slider" data-checked="on" data-unchecked="off"></span>')
                                                                            ->class('switch switch-label switch-pill switch-primary mr-2')
                                                                        ->for('role-'.$role->id) }}
            ...
            <div class="card-footer clearfix">
                ...
                <input type="hidden" name="avatar_location" id="avatar_location" value="">
                <div class="row">
                    <div class="col">
...
@push('after-scripts')
<script>
$(document).on('click', '.roledata', function(){
