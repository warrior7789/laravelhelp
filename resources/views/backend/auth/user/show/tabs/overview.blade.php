    ...
    <div class="table-responsive">
        <table class="table table-hover">
            <tr>
                @php
                    ...
                    if($user->avatar_type=='storage'){
                        if(!empty($user->avatar_location)){
                            $avatar_path = Storage::disk('public')->url($user->avatar_location);
                        }
                    }
                    if($user->avatar_type!='storage' || $user->avatar_type!='gravatar'){
                ...
                <td><img src="{{ $avatar_path }}" width="100" class="user-profile-image" /></td>
            </tr>
