...
@section('title', app_name() . ' | ' . __('strings.new.feedbacks') )
...
@section('content')
    ...
    <div class="container">
        @if(!empty($feedbacks->count()))   
            <div class="fdbk feedback-ajax-data">
                <div class="page-header">
                    <h1>{!! __('strings.new.feedbacks') !!}</h1>
                </div>
                @foreach ($feedbacks as $feeddata)
                    <div class="service-tab sp-feedback">   
    ...
    <script>
        ...
        function getPosts(page) {
            var url = '<?php echo $_ENV['APP_URL']."/feedback/ajaxfeedback/".$logged_in_user->slug."?page="?>'+page;
            $.ajax({
                url : url,
                dataType: 'html',
            }).done(function (data) {
