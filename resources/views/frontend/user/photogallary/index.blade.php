...
@section('content')
    ...
    <div class="container">
        ...
        <table class="table skill-table" data-form="deleteForm">
            <thead>
                <tr>
            ...
            <tbody>         
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success skill-b" href="{{ route('frontend.user.photogallary.edit',$phGallary->id) }}">@lang('strings.new.edit')</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-success" id="delete-btn">Delete</button>
