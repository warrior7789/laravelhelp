{{ html()->modelForm($logged_in_user, 'PATCH', route('frontend.user.profile.update'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('id', 'profile-update')->open() }}    
            ...
            <div class="col-md-12">
                <table id="addresse" class="table">
                    ...
                    <tr>
                        ...
                        <td class="label asterisk">{{ __('strings.new.zip_code') }}</td>
                        <td class="wideField">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="label">{{ __('strings.new.longitudes') }}</td>
                        <td class="wideField">
