{{ html()->form('PATCH', route('frontend.auth.password.update'))->class('form-horizontal frmchangepassword')->open() }}
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group mb-0 clearfix update-btn add-space">
