<template>
	<div class="homesearch">
		<div class="container">
			<div class="row">
				<div class="col-md-12 H-text">
					<img class="H_logo" src="img/helpii.png">
				</div>
				<div class="col-md-8 offset-md-2">
					<div class="row">
						<div class="col-md-7 col-12 Pdng">
						...
						<div class="col-md-3 col-12 Pdng1">
						...
						<div class="col-md-2 col-12">
							<button class="search-btn" type="button" @click.prevent="searchresult()" ><i class="seach-icon fas fa-search"></i></button>
						</div>
					</div>
				</div>
